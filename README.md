...
35% – Electricity costs Direct power consumption for mining hardware.

5% – Maintenance Repairs, rent, security, and cooling solutions.

10% – Reinvestment Funds held for hardware replacement at the next halving.

2. Post-Cost Allocations (50%)
From the remaining 50% of total revenue:

10% – SC Holders payout after operational costs are covered.

40% – Distribution The final amount paid out to token holders.
```
